...
Second, we need to determine the static factor dimension. This is needed for determining the maximum lag $s$ and $p$ in eqs. (1)--(2), while in the "static" method it defines the dimension of $z_t$.
