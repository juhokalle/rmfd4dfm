...
In the second step, the static factor process is modelled as a VAR process, $A(L)z_t = B\varepsilon_t$, where $A(L)$ is an $r \times r$ lag polynomial, and $B$ is an $r\times q$ constant matrix.
